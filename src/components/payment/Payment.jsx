...
const Payment = ({ setShowPayment, seats, totalAmount, showId }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed top-[50%] left-[50%] z-50 flex w-[300px] -translate-x-1/2 -translate-y-1/2 flex-col justify-between gap-6 rounded-xl border border-neutral-300 bg-neutral-50 p-6 shadow-lg md:w-[600px] md:flex-row md:p-8"
    >
      {/* Seat info */}
      ...
      {/* Payment options */}
      <div className="mr-2 space-y-4 border-neutral-300 md:border-l md:pl-6">
        <p className="text-lg font-medium md:text-center">Payment Mode</p>
